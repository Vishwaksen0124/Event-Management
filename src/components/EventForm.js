...
const EventForm = ({ onEventAdd }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className='event-form'>
            <label>Title:</label>
            <input type="text" className='input' name="title" value={newEvent.title} onChange={handleInputChange} required />
            <label>Date:</label>
            <input type="date" className='input' name="date" value={newEvent.date} onChange={handleInputChange} required />
